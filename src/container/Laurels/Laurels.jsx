...
function AwardCard({ award }) {
  return (
    <div className="app__laurels_awards-card" data-aos="fade-right" data-aos-duration="400">
  ...
  return (
    <div className="app__bg app__wrapper section__padding">
      <div className="app__wrapper_info">
        ...
        <h1 className='headtext__cormorant' data-aos="fade-down" data-aos-duration="400">Our Laurels</h1>
